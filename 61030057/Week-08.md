...
2.สร้างอาร์เรย์เก็บคะแนน gpa ของนักศึกษาในห้อง จeนวนสูงสุด 45 คน โดยใช้ตัวแปรชื่อ stuGPA, มี ชนิดข้อมูลเป็น float
``` csharp
 float[] stuGPA = new stuGPA[45];
```

3.สร้างอาร์เรย์เก็บชื่อจังหวัดในประเทศไทย โดยไม่ ต้องคำนึงถึงภาคหรือลeดับตัวอักษรใดๆ
``` csharp
int [] vil = new int [77];
```
...
2.สร้างอาร์เรย์สองมิติ ชื่อ character โดยมี 2 คอลัมน์ ส าหรับเก็บตัวอักษรตัวพิมพ์ใหญ่และพิมพ์ เล็กในภาษาอังกฤษ
```csharp
char[,] character = new char[26,2];

```

3.สร้างอาร์เรย์สองมิติ ชื่อ monthday โดยมี 2 คอลัมน์

คอลัมน์ที่ 1 เก็บจ านวนวันในแต่ละเดือน
คอลัมน์ที่ 2 เก็บเลขวันของวันที่ 1 เช่น วันที่ 1 ตรงกับวันอาทิตย์ใช้เลข 0 เป็นต้น
